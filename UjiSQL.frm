...
DT.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source= " & App.Path & "\ADOBank.mdb"
DT.RecordSource = "select * from nasabah where NoRek='xxx'"
